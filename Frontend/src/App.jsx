...
import RegisterEmail from './pages/RegisterCustomer/RegisterEmail';
...
function App() {
  return (
    <div>
      ...
      <React.Suspense fallback={<Spinner size={96} />}>
        <Toaster />
        <Router>
          <Switch>
            <Container className="p-0" fluid>
              ...
              <Route
                ...
                render={({ match: { url } }) => (
                  <>
                    <Route path={`${url}/`} component={RegisterEmail} exact />
                    <Route path={`${url}/passwd`} component={RegisterPasswd} />
                    <Route path={`${url}/submit`} component={RegisterSubmit} />
                  </>
                )}
              />
              <Route
                ...
                render={({ match: { url } }) => (
                  <>
                    <Route path={`${url}/`} component={LoginEmail} exact />
                    <Route path={`${url}/passwd`} component={LoginPasswd} />
                  </>
                )}
              />
              <Route
